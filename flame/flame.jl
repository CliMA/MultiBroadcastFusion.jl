#=
using Revise; include(joinpath("flame", "flame.jl"))
=#

import MultiBroadcastFusion as MBF
include(joinpath(pkgdir(MBF), "test", "execution", "utils_setup.jl"))
...
X = get_arrays(:x, AType, Float64, arr_size)
Y = get_arrays(:y, AType, Float64, arr_size)
